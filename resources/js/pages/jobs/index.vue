    ...
    <VRow justify="center">
      ...
      >
        ...
        >
            ...
            <VExpandTransition>
              <div v-if="job.commentOpen">
                ...
                <VCardText>
                  ...
                  <div
                    v-else-if="job.comments && job.comments.length > 0"
                    class="mb-4"
                  >
                    <div
                  ...
                  <div class="d-flex gap-2">
                    ...
                    <VBtn
                      ...
                      variant="text"
                      color="primary"
                      :loading="job.postingComment"
                      @click="postComment(job)"
                    />
                  </div>
                </VCardText>
              </div>
          ...
          <div
            v-if="jobs.length > 0 && page < lastPage"
            ref="target"
          ...
          <div
            v-if="page >= lastPage && jobs.length > 0"
