        ...
        <VCard title="Riwayat Transaksi">
            ...
            >
                ...
                <template #item.type="{ item }">
                    <VChip :color="resolveTypeVariant(item.type)" size="small" label class="text-capitalize">
                        {{ item.type }}
                    </VChip>
                </template>

                <template #item.amount="{ item }">
                    <span :class="resolveTypeVariant(item.type) === 'error' ? 'text-error' : 'text-success'" class="font-weight-medium">
