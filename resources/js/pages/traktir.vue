  ...
  <VRow justify="center">
    <VCol cols="12" md="8" lg="6">
      <VCard class="pa-4">
        <VCardItem>
          <template #prepend>
            <VIcon icon="bx-coffee-togo" size="32" color="primary" class="me-2" />
          </template>
        ...
        <VCardText v-if="!result" class="mt-4">
        ...
        <VCardText v-else class="text-center mt-4">
          <VIcon icon="bx-check-circle" color="success" size="64" class="mb-4" />
          <h3 class="text-h5 font-weight-bold mb-2">Terima Kasih!</h3>
          <p class="text-body-2 mb-6">
            Silakan scan QRIS di bawah ini untuk menyelesaikan traktiranmu.
          </p>

          <div class="d-flex justify-center mb-6 pa-4 bg-grey-50 rounded border mx-auto" style="max-width: 300px;">
              ...
              <VImg
                  ...
                  height="250"
              />
              <div v-else class="text-break w-100">
                  <p class="mb-2">Scan QRIS pada aplikasi pembayaran Anda:</p>
        ...
        <VCardText v-if="error" class="text-center text-error">
          {{ error }}
        </VCardText>
      </VCard>
    </VCol>
        ...
        <VTable>
          ...
          <tbody>
            ...
            <tr v-if="donations.length === 0">
                <td colspan="4" class="text-center text-medium-emphasis">Belum ada donasi.</td>
            </tr>
          </tbody>
        </VTable>
      </VCard>
