        ...
        <VCard class="mb-6">
          <VCardItem class="text-center py-6">
            ...
            <h2 class="text-h4 font-weight-bold">
              Peringkat Penghasilan Tertinggi
            </h2>
            <p class="text-medium-emphasis">
              Peringkat berdasarkan total penghasilan dari pekerjaan yang diselesaikan.
            </p>
          </VCardItem>
        </VCard>
            ...
            <tbody>
              ...
              >
                <td class="text-center">
                  <VAvatar
                    :color="resolveRankColor(index)"
                    size="36"
                    variant="tonal"
                  >
                    <VIcon
                      :icon="resolveRankIcon(index)"
                      size="20"
                    />
                  </VAvatar>
                </td>
