...
<template>
  <div class="landing-page bg-surface">
        ...
        <VRow align="center">
          ...
          >
            <VChip
              ...
              label
            >
              🚀 Platform Microtask No. #1 Indonesia
            </VChip>
        ...
        >
          ...
          >
            <h3 class="text-h3 font-weight-bold">
              {{ formatNumber(stats.total_taskers) }}
            </h3>
          ...
          >
            <h3 class="text-h3 font-weight-bold">
              {{ formatNumber(stats.total_tasks_completed) }}
            </h3>
            <p class="mb-0 text-white-50">
              Tugas Selesai
            </p>
          ...
          >
            <h3 class="text-h3 font-weight-bold">
              IDR {{ formatCurrency(stats.total_payout) }}
            </h3>
            <p class="mb-0 text-white-50">
              Terbayarkan
            </p>
    ...
    >
      <div class="text-center mb-12">
        ...
        <p class="text-body-1 text-medium-emphasis">
          Cuma butuh 4 langkah buat mulai ngehasilin duit.
        </p>
      </div>
      ...
      <VRow>
        ...
        >
          <div class="step-card pa-6 rounded-xl hover-elevate">
            <div
              class="step-number bg-primary text-h4 font-weight-bold rounded-circle d-flex align-center justify-center mx-auto mb-4"
    ...
    <div class="bg-grey-100 py-16">
      <VContainer>
        <div class="text-center mb-12">
          ...
          <p class="text-body-1 text-medium-emphasis">
            Banyak pilihan tugas yang bisa kamu kerjakan.
          </p>
        </div>
        <VRow>
          <VCol
      ...
      <VRow align="center">
        ...
        >
          <h2 class="text-h3 font-weight-bold mb-6">
            Kenapa Pilih <span class="text-primary">CuanTask</span>?
          </h2>
    ...
    <div class="bg-primary py-16 position-relative overflow-hidden text-inverse-surface">
      ...
      <div
        class="position-absolute top-0 right-0 mt-n16 mr-n16 rounded-circle bg-white opacity-10 d-none d-md-block"
        style="width: 600px; height: 600px; filter: blur(80px);"
      />
      <div
        class="position-absolute bottom-0 left-0 mb-n16 ml-n16 rounded-circle bg-warning opacity-10 d-none d-md-block"
        style="width: 400px; height: 400px; filter: blur(60px);"
      />
      ...
      >
        ...
        >
          ...
          >
            <VCard
              class="pa-6 rounded-xl border-dashed bg-white"
              theme="light"
              elevation="10"
            ...
            >
              <VRow dense>
                <VCol cols="6">
                  <VCard
                    class="d-flex flex-column align-center justify-center pa-4 bg-grey-50 rounded-xl text-center h-100 hover-elevate"
                    flat
                    border
                  >
                    <VAvatar
                    ...
                    <h4 class="font-weight-bold text-subtitle-2 text-wrap">
                      Target Tepat
                    </h4>
                  </VCard>
                </VCol>
          ...
          >
            ...
            <p
              class="text-h6 opacity-90 mb-8 font-weight-regular"
              style="line-height: 1.6;"
            >
            ...
            <div class="d-flex flex-wrap gap-4">
              <VBtn
                size="x-large"
                color="white"
                class="text-primary font-weight-bold px-8 shadow-lg"
    ...
    >
      <div class="text-center mb-12">
        ...
        <p class="text-body-1 text-medium-emphasis">
          Apa kata user yang udah nyobain CuanTask.
        </p>
      </div>
      <VRow justify="center">
        <VCol
        ...
        >
          ...
          >
            ...
            <p class="text-body-1 fst-italic">
              "{{ item.text }}"
            </p>
        ...
        <VCard class="bg-primary text-white py-12 px-6 rounded-xl overflow-visible position-relative">
          ...
          >
            <h2 class="text-h3 font-weight-bold mb-4">
              Yuk, Mulai Dapetin Cuan Hari Ini!
            </h2>
            <p class="text-h6 mb-8 opacity-90">
              Gabung bareng ribuan user lainnya yang udah cairin rupiah.
            </p>
            <VBtn
              color="white"
              size="x-large"
